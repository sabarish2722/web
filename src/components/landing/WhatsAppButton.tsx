...
export default function WhatsAppButton({ phoneNumber }: { phoneNumber: string }) {
  ...
  return (
    <Link
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform duration-300 ease-in-out hover:scale-110 hover:bg-[#128C7E]"
